      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="subtle-shadow">
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                { name: 'Income Statement', icon: <BarChart4 className="h-4 w-4" /> },
                { name: 'Balance Sheet', icon: <FileText className="h-4 w-4" /> },
                { name: 'Cash Flow', icon: <DollarSign className="h-4 w-4" /> },
                { name: 'Tax Summary', icon: <FileText className="h-4 w-4" /> },
                { name: 'Budget Report', icon: <CreditCard className="h-4 w-4" /> }
              ].map((report, i) => (
                <div key={i} className="flex items-center justify-between p-3 rounded-md hover:bg-muted hover-scale">
                  <div className="flex items-center space-x-3">
