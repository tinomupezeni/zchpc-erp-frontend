            ...
            {/* <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  name="nssaNumber"
                  value={employee.nssaNumber}
                  onChange={handleChange}
                  required
                  className="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                  placeholder="NSSA membership number"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <input
                  type="text"
                  name="zimraPin"
                  value={employee.zimraPin}
                  onChange={handleChange}
                  required
                  className="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                  placeholder="ZIMRA tax identification"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <input
                  type="text"
                  name="payeNumber"
                  value={employee.payeNumber}
                  onChange={handleChange}
                  className="w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                  placeholder="Employer's P.A.Y.E registration"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
